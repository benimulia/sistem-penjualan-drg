...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <form name="beritaForm" action="{{ route('pelanggan.update',['id' => $pelanggan->id_pelanggan]) }}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_pelanggan" placeholder="Masukkan nama pelanggan.." name="nama_pelanggan" required value="{{$pelanggan->nama_pelanggan}}" disabled=true>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            <div class="form-group">
                <label for="no_hp">Nomor HP :</label>
                <input type="number" class="form-control" id="no_hp" placeholder="Masukkan no hp.." name="no_hp" required value="{{$pelanggan->no_hp}}" disabled=true>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            <div class="form-group">
                <label for="alamat_pelanggan">Alamat :</label>
                <input type="text" class="form-control" id="alamat_pelanggan" placeholder="Masukkan alamat pelanggan.." name="alamat_pelanggan" required value="{{$pelanggan->alamat_pelanggan}}" disabled=true>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            <div class="form-group">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input form-control" id="foto_pelanggan" name="foto_pelanggan" accept=".jpg,.jpeg,.png" disabled=true />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 ">
                <img src="/gambar/pelanggan/foto-pelanggan/{{$pelanggan->foto_pelanggan}}" style="max-height: 160px;" id="profile-img-tag">
            </div>

            <div class="form-group">
                <label for="foto_identitas">Upload foto identitas :</label> <br>
                <div class="custom-file">
                    <input type="file" class="custom-file-input form-control" id="foto_identitas" name="foto_identitas" accept=".jpg,.jpeg,.png" disabled=true />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 ">
                <img src="/gambar/pelanggan/foto-pelanggan/{{$pelanggan->foto_identitas}}" style="max-height: 100px;" id="identitas-img-tag">
            </div>
