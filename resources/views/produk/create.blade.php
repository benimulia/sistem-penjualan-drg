    ...
    <div class="col-sm-12 col-md-12">
        <form id="produkForm" class="needs-validation" novalidate action="{{route('produk.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="harga_cash" placeholder="Masukkan harga cash produk.." name="harga_cash" required onkeypress='validateInt(event)'>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="harga_bon" placeholder="Masukkan harga bon produk.." name="harga_bon" required onkeypress='validateInt(event)'>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
